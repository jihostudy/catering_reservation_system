...
#### 방법 1: (준비중, 사용 불가) Chrome Web Store에서 설치
...
- **평균 4ms 성공률**: 빠른 처리 속도로 높은 예약 성공률 확보

### 3.2 알림 시스템

- **예약 전 알림**: 예약 10분 전, 5분 전 알림으로 사전 준비
- **결과 알림**: 예약 성공/실패 시 즉시 데스크탑 알림
- **차수 정보**: 몇 차수 예약인지 명확하게 표시
...
- 예약 시간에 케이터링 페이지 자동 열기
- Content Script로 폼 자동 입력 및 제출
- 예약 결과 감지 및 데스크탑 알림 표시
- Service Worker 활성 상태 유지

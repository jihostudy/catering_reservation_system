      ...
      <section className="min-h-screen flex items-center justify-center relative py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="text-center">
            ...
            <div className="mb-6">
              <div className="mb-2">
                <span className="text-sm sm:text-base font-semibold text-green-600 dark:text-green-400 tracking-wide">
                  올리브영
                </span>
              </div>
            ...
            <div className="max-w-3xl mx-auto mb-8">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-gray-900 dark:text-white mb-4 leading-tight">
                올리브영 케이터링 예약,
                <br />
                <span className="text-green-600 dark:text-green-400">자동으로</span> 간편하게
              </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                오후 3시 정각에 자동으로 실행됩니다. 밀리초 단위의 정확한 타이밍으로 올리브영 케이터링 예약 성공률을 극대화합니다.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                올리브영 케이터링 예약 정보를 자동으로 입력하고 제출합니다. 이메일, 이름, 사번, 케이터링 타입을 한 번만 설정하면 됩니다.
              </p>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                올리브영 케이터링 예약 상태와 이력을 실시간으로 확인할 수 있습니다. 성공/실패 여부를 즉시 알림으로 받아보세요.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                올리브영 케이터링 예약에 필요한 정보를 한 번만 입력합니다.
              </p>
            </div>
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                정확한 시간에 올리브영 케이터링 예약을 자동으로 완료하고 알림을 받습니다.
          </p>
            </div>
          </div>
        </div>
